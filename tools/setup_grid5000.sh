...
echo 'deb [check-valid-until=no] http://snapshot.debian.org/archive/debian/20190517T212027Z/ stretch-proposed-updates main' > /etc/apt/sources.list.d/snapshot-kernel.list
apt-get update
