...
echo 'deb [check-valid-until=no] http://snapshot.debian.org/archive/debian-security/20180809T094339Z/ stretch/updates main' > /etc/apt/sources.list.d/snapshot-kernel.list
apt-get update
